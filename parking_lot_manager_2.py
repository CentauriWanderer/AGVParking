...
class PARKING_LOT_MANAGER:
    ...
    def __init__(self, cp, p, pt, vl, aq, sort):
    ...
    def step(self, stp):
        ...
        if not stp % 90:
            self.CapacityPlot.append(self.Capacity)
            self.TypeACapacityPlot.append(self.TypeACapacity)
            self.TypeBCapacityPlot.append(self.TypeBCapacity)
            self.TypeCCapacityPlot.append(self.TypeCCapacity)
            self.TypeDCapacityPlot.append(self.TypeDCapacity)
            self.TypeECapacityPlot.append(self.TypeECapacity)
    ...
    def summary(self):
        return self.ReallocateCount / self.EnterCount